...
urlpatterns = [
    ...
    url(r'^categories/read/detail/(?P<pk>\d+)/$', adminapp.CategoryDetailView.as_view(), name='category_detail'),
    ...
    url(r'^categories/delete/(?P<pk>\d+)/$', adminapp.CategoryDeleteView.as_view(), name='category_delete'),
